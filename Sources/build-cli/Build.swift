...
struct Build: ParsableCommand {
  static var configuration: CommandConfiguration {
    .init(subcommands: [
      ...
      PackageBuildCommand<Adjust>.self,
      PackageBuildCommand<Aom>.self,
      PackageBuildCommand<Aribb24>.self,
      PackageBuildCommand<Asharp>.self,
      ...
      PackageBuildCommand<Fluxsmooth>.self,
      ...
      PackageBuildCommand<Gflags>.self,
      ...
      PackageBuildCommand<Havsfunc>.self,
      PackageBuildCommand<Highway>.self,
      PackageBuildCommand<Hqdn3d>.self,
      ...
      PackageBuildCommand<LibtorrentRasterbar>.self,
      PackageBuildCommand<Libuv>.self,
      ...
      PackageBuildCommand<MediaBundle>.self,
      PackageBuildCommand<MediaInfo>.self,
      PackageBuildCommand<MediaInfoLib>.self,
      PackageBuildCommand<Meson>.self,
      PackageBuildCommand<MiscFilters>.self,
      PackageBuildCommand<Mkvtoolnix>.self,
      PackageBuildCommand<Mozjpeg>.self,
      PackageBuildCommand<Mpc>.self,
      PackageBuildCommand<Mpdecimal>.self,
      PackageBuildCommand<Mpfr>.self,
      PackageBuildCommand<Mpv>.self,
      PackageBuildCommand<Mvsfunc>.self,
      ...
      PackageBuildCommand<Nghttp2>.self,
      ...
      PackageBuildCommand<VapoursynthBundle>.self,
      PackageBuildCommand<Vivtc>.self,
      ...
      PackageBuildCommand<Znedi3>.self,
