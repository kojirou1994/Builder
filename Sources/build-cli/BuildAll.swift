...
struct BuildAll: ParsableCommand {
  static var configuration: CommandConfiguration {
    .init(subcommands: [
      ...
      PackageBuildAllCommand<AutoconfArchive>.self,
      ...
      PackageBuildAllCommand<Mpdecimal>.self,
      ...
      PackageBuildAllCommand<Readline>.self,
      ...
      PackageBuildAllCommand<Tinyxml2>.self,
